...
public class channel extends AppCompatActivity {
    ...
    String searchName;
    String TAG="channel";
    String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCCjAYRuosoIm6huzZiAcEaQ&maxResults=25&q=surfing&key={YOUR_API_KEY}";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customListAdapter=new CustomlistAdapter(channel.this,videoDetailsArrayList);
        showVideo();
    }
